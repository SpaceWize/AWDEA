...
const ImagePlaceholder = ({ label, className = '' }: ImagePlaceholderProps) => (
  <div
    ...
    className={`flex flex-col items-center justify-center gap-3 rounded-3xl border-2 border-dashed border-slate-300 bg-[var(--color-mist)] p-6 text-center ${className}`}
  >
    <svg
      width="34"
      height="34"
